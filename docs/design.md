...
5. *Verdict.* The consistency points established in step 3 are quiesced only when steps 2 and 4 both held. Copying or uploading an established snapshot happens after step 4 and is not bound by the lease; a verdict, once reached, is not revisited because a later upload ran long.
