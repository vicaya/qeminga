...
| AC22 freeze-validity contract | T6.3 (`tests/controller_contract.rs`, the fifteen scenarios listed there) | integration (paused time, depth-tracking fake) | green; single-controller assumption stated, OQ-9 |
